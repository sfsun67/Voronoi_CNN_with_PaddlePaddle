...
| 步骤 | 阈值 | 额外说明 |
| --- | --- | --- |
| 前向对齐 | 1e-6 | 前向对齐验证模型的网络结构代码转换、权重转换、模型组网的正确性。一般小于1e-6的话，可以认为前向没有问题。 |
| 损失函数对齐 | 1e-5 | 计算loss的时候，建议设置model.eval()，避免模型中随机量的问题。 |
| 反向对齐 | 1e-4 | 反向对齐验证两个代码的训练超参数全部一致。经过2轮以上，loss均可以对齐，则基本可以认为反向对齐。 |
...
bp_align_diff：
		loss_0:0.0    
		loss_1:2.6332460038247518e-05    
		loss_2:1.3369167390919756e-05
train_align_diff：0.007732505130767842

Model_noaa 程序：
forward_diff：4.3181091768929036e-07
loss_diff：1.9857959614455467e-06
bp_align_diff：
		loss_0:2.7497021619637962e-06  
		loss_1:2.63029032794293e-05  
		loss_2:1.334571516053984e-05
```
